            ...
            <div class="row">
                ...
                <div class="col-md-6 right-side">
                    <ul class="right">
                        ...
                        <li class="menu">
                            <a href="{{ route('registration') }}"><i class="fas fa-user"></i> Daftar</a>
                        </li>
                        @endif
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="item pb_50">
                        <h2 class="heading">Halaman Penting</h2>
                        <ul class="useful-links">
                            <li><a href="{{ route('home') }}"><i class="fas fa-angle-right"></i> Beranda</a></li>
                            <li><a href="{{ route('destinations') }}"><i class="fas fa-angle-right"></i> Destinasi</a></li>
                            <li><a href="{{ route('packages') }}"><i class="fas fa-angle-right"></i> Paket</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item pb_50">
                        ...
                        <ul class="useful-links">
                            <li><a href="{{ route('faq') }}"><i class="fas fa-angle-right"></i> Pertanyaan</a></li>
                            <li><a href="{{ route('terms') }}"><i class="fas fa-angle-right"></i> Ketentuan Penggunaan</a></li>
                            <li><a href="{{ route('privacy') }}"><i class="fas fa-angle-right"></i> Kebijakan Privasi</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item pb_50">
                        <h2 class="heading">Buletin</h2>
                        <p>
                            Untuk mendapatkan berita terbaru dari situs web kami, silakan berlangganan kami di sini:
                        </p>
                        ...
                        <form action="{{ route('subscriber_submit') }}" method="POST">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary" value="Berlangganan Sekarang">
                            </div>
                        </form>
