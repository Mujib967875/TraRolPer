                ...
                <div class="col-md-12">
                    ...
                    <div class="breadcrumb-container">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Semua Paket</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="package-sidebar">
                        <form action="{{ route('packages') }}" method="get">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" name="name" class="form-control"
                                                placeholder="Nama Paket ..." value="{{ $form_name }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget">
                                <h2>Filter berdasarkan destinasi</h2>
                                <div class="box">
                            ...
                            <div class="widget">
                                <h2>Filter berdasarkan ulasan</h2>
                                <div class="box">
                                ...
                                <div class="item pb_25">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="element">
                                            ...
                                            <div class="element-right">
                                                <i class="fas fa-clock"></i> {{ $item->package_itinerary->count() }} Hari
                                            </div>
                                        </div>
                                    </div>
                                </div>
