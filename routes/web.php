...
Route::middleware('admin')
    ...
    ->group(function () {
        ...
        // Features Section
        Route::get('/features/index', [AdminFeatureController::class, 'index'])->name('admin_feature_index');
        ...
        Route::get('/counter-items/index', [AdminCounterItemController::class, 'index'])->name('admin_counter_item_index');
        Route::post('/counter-item/update', [AdminCounterItemController::class, 'update'])->name('admin_counter_item_update');

        // Testimonials Section
        Route::get('/testimonials/index', [AdminTestimonialController::class, 'index'])->name('admin_testimonial_index');
        ...
        Route::get('/team-members/index', [AdminTeamMemberController::class, 'index'])->name('admin_team_member_index');
        ...
        // Faqs Section
        Route::get('/faqs/index', [AdminFaqController::class, 'index'])->name('admin_faq_index');
        ...
        Route::get('/blog-categories/index', [AdminBlogCategoryController::class, 'index'])->name('admin_blog_category_index');
        ...
        // Posts Section
        Route::get('/posts/index', [AdminPostController::class, 'index'])->name('admin_post_index');
        ...
        Route::get('/destinations/index', [AdminDestinationController::class, 'index'])->name('admin_destination_index');
        ...
        Route::get('/destination-photos/{id}', [AdminDestinationController::class, 'destination_photos'])->name('destination_photos');
        ...
        Route::get('/package-amenities/{package_id}/photos/{amenity_id}', [AdminPackageController::class, 'package_amenity_photos'])->name('package_amenity_photos');
        ...
        Route::get('/package-itineraries/{id}', [AdminPackageController::class, 'package_itineraries'])->name('package_itineraries');
        ...
        Route::get('/package-photos/{id}', [AdminPackageController::class, 'package_photos'])->name('package_photos');
        ...
        Route::get('/package-videos/{id}', [AdminPackageController::class, 'package_videos'])->name('package_videos');
        ...
        Route::get('/package-faqs/{id}', [AdminPackageController::class, 'package_faqs'])->name('package_faqs');
        ...
        // Amenities Section
        Route::get('/amenities/index', [AdminAmenityController::class, 'index'])->name('admin_amenity_index');
        ...
        // Tours Section
        Route::get('/tours/index', [adminTourController::class, 'index'])->name('admin_tour_index');
        ...
        Route::get('/tours/booking/{tour_id}/{package_id}', [AdminTourController::class, 'tour_booking'])->name('admin_tour_booking');
        ...
        // About Items Section
        Route::get('/about-items/index', [AdminAboutItemController::class, 'index'])->name('admin_about_item_index');
        Route::post('/about-item/update', [AdminAboutItemController::class, 'update'])->name('admin_about_item_update');

         // Contact Items Section
         Route::get('/contact-items/index', [AdminContactItemController::class, 'index'])->name('admin_contact_item_index');
         ...
         // Settings Section
        Route::get('/settings/index', [AdminSettingController::class, 'index'])->name('admin_setting_index');
        Route::post('/setting/update', [AdminSettingController::class, 'update'])->name('admin_setting_update');

        // Sponsor Section
        Route::get('/sponsor/index', [AdminSponsorController::class, 'index'])->name('sponsor_index');
        ...
        // Comment Section
        Route::get('/comment/index', [AdminCommentController::class, 'index'])->name('comment.index');
        ...
        Route::get('/amenity/trash', [AdminTrashController::class, 'AmenityTrash'])->name('admin_amenity_trash');
        ...
        Route::get('/review/trash', [AdminTrashController::class, 'ReviewTrash'])->name('admin_review_trash');
        ...
        Route::get('/feature/trash', [AdminTrashController::class, 'FeatureTrash'])->name('admin_feature_trash');
        ...
        Route::get('/destination/trash', [AdminTrashController::class, 'DestinationTrash'])->name('admin_destination_trash');
        ...
        Route::get('/destination/photo/trash', [AdminTrashController::class, 'DestinationPhotoTrash'])->name('admin_destination_photo_trash');
        ...
        Route::get('/destination/video/trash', [AdminTrashController::class, 'DestinationVideoTrash'])->name('admin_destination_video_trash');
        ...
        Route::get('/blog/category/trash', [AdminTrashController::class, 'BlogCategoryTrash'])->name('admin_blog_category_trash');
        ...
        // Blog Trash Section
        Route::get('/blog/trash', [AdminTrashController::class, 'BlogTrash'])->name('admin_blog_trash');
        ...
        Route::get('/package/trash', [AdminTrashController::class, 'PackageTrash'])->name('admin_package_trash');
        ...
        Route::get('/package/amenity/trash', [AdminTrashController::class, 'PackageAmenityTrash'])->name('admin_package_amenity_trash');
        ...
        Route::get('/package/itinerary/trash', [AdminTrashController::class, 'PackageItineraryTrash'])->name('admin_package_itinerary_trash');
        ...
        Route::get('/package/faq/trash', [AdminTrashController::class, 'PackageFaqTrash'])->name('admin_package_faq_trash');
        ...
        Route::get('/package/photo/trash', [AdminTrashController::class, 'PackagePhotoTrash'])->name('admin_package_photo_trash');
        ...
        Route::get('/package/video/trash', [AdminTrashController::class, 'PackageVideoTrash'])->name('admin_package_video_trash');
        ...
        // Tour Trash Section
        Route::get('/tour/trash', [AdminTrashController::class, 'TourTrash'])->name('admin_tour_trash');
        ...
        Route::get('/booking/trash', [AdminTrashController::class, 'BookingTrash'])->name('admin_booking_trash');
        ...
        Route::get('/subscriber/trash', [AdminTrashController::class, 'SubscriberTrash'])->name('admin_subscriber_trash');
        ...
        // User Trash Section
        Route::get('/user/trash', [AdminTrashController::class, 'UserTrash'])->name('admin_user_trash');
        ...
        Route::get('/testimonial/trash', [AdminTrashController::class, 'TestimonialTrash'])->name('admin_testimonial_trash');
        ...
        // FAQ Trash Section
        Route::get('/faq/trash', [AdminTrashController::class, 'FAQTrash'])->name('admin_faq_trash');
        ...
        Route::get('/team_member/trash', [AdminTrashController::class, 'TeamMemberTrash'])->name('admin_team_member_trash');
        ...
        Route::get('/sponsor/trash', [AdminTrashController::class, 'SponsorTrash'])->name('admin_sponsor_trash');
