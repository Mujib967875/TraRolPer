        ...
        <ul class="navbar-nav navbar-right justify-content-end rightsidetop">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('admin_profile') }}"><i class="far fa-user"></i> Ubah Profil</a></li>
                    <li><a class="dropdown-item" href="{{ route('admin_logout') }}"><i class="fas fa-sign-out-alt"></i> Keluar</a></li>
                </ul>
            </li>
        </ul>
    </nav>
